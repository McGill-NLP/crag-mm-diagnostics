...
class BaseAgent:
    ...
    def __init__(self, search_pipeline: CustomSearchPipeline | None, model_name: Optional[str] = None):
        """
        Initialize the BaseAgent.
        
        Args:
            search_pipeline (CustomSearchPipeline): A pipeline for searching web and image content.
            Note: The web-search will be disabled in case of Task 1 (Single-source Augmentation) - so only image-search can be used in that case.
        """
